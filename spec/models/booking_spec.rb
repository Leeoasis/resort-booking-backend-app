...
RSpec.describe Booking, type: :model do
  describe 'validations' do
    it 'is valid with valid attributes' do
      ...
      resort = Resort.create(name: 'Resort Name', address: '123 Main St.', description: 'A beautiful resort',
                             phone_number: 1_234_567_890, email: 'resort@example.com', country: 'USA', city: 'New York',
                             available_rooms: 10, max_occupancy: 20, base_price: 100, user_id: user.id)
